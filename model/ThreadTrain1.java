...
public class ThreadTrain1 extends Thread{
  ...
  //Flags para deifinir se o trem esta passando na zona critica
  ...
  public ThreadTrain1(int initialPosition, ImageView imageView, Slider speedSlider, int solucao){
  ...
  private class MyTimer extends AnimationTimer {
        private ThreadTrain1 train;

        public MyTimer(ThreadTrain1 train){
          this.train = train;
        }
  ...
  AnimationTimer movimentationTimer = new MyTimer(this);//instancia da classe MyTimer que controla o timer de animacao
  public AnimationTimer getMovimentationTimer(){//retorna o timer da animacao
    ...
    public void moveTrain(){
      ...
      switch(this.getInitialPosition()){
        case 1:{//Descreve os movimentos do trem na posicao superior esquerda
          if(this.getImageView().getLayoutY() <= 8){
            this.getImageView().setLayoutY(this.getImageView().getLayoutY() + inc);
          }
          //INICIO ZONA CRITICA 1
          if(this.getImageView().getLayoutY() > 8 && this.getImageView().getLayoutY() <= 86){
          ...
          if(this.getImageView().getLayoutY() > 86 && this.getImageView().getLayoutY() <= 120){
            this.getImageView().setRotate(0);
            this.getImageView().setLayoutY(this.getImageView().getLayoutY() + inc);
          }
          if(this.getImageView().getLayoutY() > 120 && this.getImageView().getLayoutY() <= 192){
            this.getImageView().setRotate(315);
            this.getImageView().setLayoutY(this.getImageView().getLayoutY() + inc);
            this.getImageView().setLayoutX(this.getImageView().getLayoutX() + inc);
          }
          //FIM ZONA CRITICA 1
          if(this.getImageView().getLayoutY() > 192 && this.getImageView().getLayoutY() <= 279){
            saiRC1(solucao);//executa os passos de saida da zona critica dos diferentes metodos
            this.getImageView().setRotate(0);
            this.getImageView().setLayoutY(this.getImageView().getLayoutY() + inc);
          }
          //INICIO ZONA CRITICA 2
          if(this.getImageView().getLayoutY() > 279 && this.getImageView().getLayoutY() <= 343){
          ...
          if(this.getImageView().getLayoutY() > 343 && this.getImageView().getLayoutY() <= 402){
            this.getImageView().setRotate(0);
            this.getImageView().setLayoutY(this.getImageView().getLayoutY() + inc);
          }
          if(this.getImageView().getLayoutY() > 402 && this.getImageView().getLayoutY() <= 486){
            this.getImageView().setRotate(45);
            this.getImageView().setLayoutY(this.getImageView().getLayoutY() + inc);
            this.getImageView().setLayoutX(this.getImageView().getLayoutX() - inc);
          }
          //FIM ZONA CRITICA 2
          if(this.getImageView().getLayoutY() > 486 && this.getImageView().getLayoutY() <= 624){
            saiRC2(solucao);//executa os passos de saida da zona critica dos diferentes metodos
            this.getImageView().setRotate(0);
            this.getImageView().setLayoutY(this.getImageView().getLayoutY() + inc);
          }
          if(this.getImageView().getLayoutY() > 624){
            this.getImageView().setLayoutX(290);
            this.getImageView().setLayoutY(-135);
          }
          break;
        }//fim case 1
        case 3:{//Descreve os movimentos do trem na posicao inferior esquerda
          if(this.getImageView().getLayoutY() >= 482){
            this.getImageView().setRotate(180);
            this.getImageView().setLayoutY(this.getImageView().getLayoutY() - inc);
          }
          //INICIO ZONA CRITICA 2
          if(this.getImageView().getLayoutY() < 482 && this.getImageView().getLayoutY() >= 399){
            if(!entraRC2(solucao) && !critZone2){//testa a condicao do metodo selecionado e se o trem ja passou da zona critica
              break;//se entrar na condicao o movimento do trem eh bloqueado nao entrando na zona critica
            }
          ...
          if(this.getImageView().getLayoutY() < 399 && this.getImageView().getLayoutY() >= 342){
            this.getImageView().setRotate(180);
            this.getImageView().setLayoutY(this.getImageView().getLayoutY() - inc);
          }        
          if(this.getImageView().getLayoutY() < 342 && this.getImageView().getLayoutY() >= 278){
            this.getImageView().setRotate(225);
            this.getImageView().setLayoutY(this.getImageView().getLayoutY() - inc);
            this.getImageView().setLayoutX(this.getImageView().getLayoutX() + inc);
          }
          //FIM ZONA CRITICA 2
          if(this.getImageView().getLayoutY() < 278 && this.getImageView().getLayoutY() >= 191){
            saiRC2(solucao);//executa os passos de saida da zona critica dos diferentes metodos
            this.getImageView().setRotate(180);
            this.getImageView().setLayoutY(this.getImageView().getLayoutY() - inc);
          }
          //INICIO ZONA CRITICA 1
          if(this.getImageView().getLayoutY() < 191 && this.getImageView().getLayoutY() >= 118){
            if(!entraRC1(solucao) && !critZone1){//testa a condicao do metodo selecionado e se o trem ja passou da zona critica
              break;//se entrar na condicao o movimento do trem eh bloqueado nao entrando na zona critica
            }       
          ...
          if(this.getImageView().getLayoutY() < 118 && this.getImageView().getLayoutY() >= 85){
            this.getImageView().setRotate(180);
            this.getImageView().setLayoutY(this.getImageView().getLayoutY() - inc);
          }
          if(this.getImageView().getLayoutY() < 85 && this.getImageView().getLayoutY() >= 8){
            this.getImageView().setRotate(135);
            this.getImageView().setLayoutY(this.getImageView().getLayoutY() - inc);
            this.getImageView().setLayoutX(this.getImageView().getLayoutX() - inc);
          }
          //FIM ZONA CRITICA 1 
          if(this.getImageView().getLayoutY() < 8 && this.getImageView().getLayoutY() >= -135){
            saiRC1(solucao);//executa os passos de saida da zona critica dos diferentes metodos
            this.getImageView().setRotate(180);
            this.getImageView().setLayoutY(this.getImageView().getLayoutY() - inc);
          }
          if(this.getImageView().getLayoutY() < -135){
            this.getImageView().setLayoutX(294);
  ...
  /* ***************************************************************
    * Metodo: entraRC1
    * Funcao: Aplica o metodo selecionado para definir se a thread pode ou nao acessar a zona critica 1
    * Parametros: solucao eh a solucao escolhida
    * Retorno: boolean caso false nao pode entrar na zona critica e fica em loop, caso true pode acessar a zona critica
    *************************************************************** */
    ...
    switch(solucao){//solucao eh a definida pelo usuario
      ...
      case 1:{//estrita alternancia
        if(TrackScreenController.turn1 == 1){//turn1 eh uma variavel estatica definida na classe de controle
          return false;
        } else {
          critZone1 = true;//flag setada como true para indicar que o trem ja acessou a regiao critica e pode continuar acessando 
          return true;
      ...
      case 2:{//solucao de peterson
        ...
        if(TrackScreenController.turnP1 == processo && TrackScreenController.interesse1[other] == true){//turnP1 e interesse sao variaveis estaticas definida na classe de controle
          return false;
        } else {
          critZone1 = true;//flag setada como true para indicar que o trem ja acessou a regiao critica e pode continuar acessando 
          return true;
  ...
  /* ***************************************************************
    * Metodo: saiRC1
    * Funcao: Aplica o metodo selecionado para realizar os controles quando uma thread sai da zona critica 1
    * Parametros: solucao eh a solucao escolhida
    * Retorno: void
    *************************************************************** */
  private void saiRC1(int solucao){
    switch(solucao){
      ...
      case 1:{//estrita alternancia
        TrackScreenController.turn1 = 1;//turn1 eh uma variavel estatica definida na classe de controle
        critZone1 = false;//flag setada como false para indicar que o trem ja passou pela regiao critica 1
        break;
      }
      case 2:{//solucao de peterson
  ...
  /* ***************************************************************
    * Metodo: entraRC2
    * Funcao: Aplica o metodo selecionado para definir se a thread pode ou nao acessar a zona critica 2
    * Parametros: solucao eh a solucao escolhida
    * Retorno: boolean caso false nao pode entrar na zona critica e fica em loop, caso true pode acessar a zona critica
    *************************************************************** */
  private boolean entraRC2(int solucao){
    switch(solucao){//variavel de travamento
      ...
      case 1:{//estrita alternancia
        if(TrackScreenController.turn2 == 1 ){//turn2 eh uma variavel estatica definida na classe de controle
          return false;
        } else {
          critZone2 = true;//flag setada como true para indicar que o trem ja acessou a regiao critica e pode continuar acessando 
          return true;
  ...
  /* ***************************************************************
    * Metodo: saiRC2
    * Funcao: Aplica o metodo selecionado para realizar os controles quando uma thread sai da zona critica 2
    * Parametros: solucao eh a solucao escolhida
    * Retorno: void
    *************************************************************** */
  private void saiRC2(int solucao){
    switch(solucao){
      ...
      case 1:{//estrita alternancia
        TrackScreenController.turn2 = 1;//turn2 eh uma variavel estatica definida na classe de controle
        critZone2 = false;//flag setada como false para indicar que o trem ja passou pela regiao critica 2
        break;
      }
      case 2:{//solucao de peterson
